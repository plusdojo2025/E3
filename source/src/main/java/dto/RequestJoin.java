...
public class RequestJoin implements Serializable{
	...
	public RequestJoin(int request_id, int id, double current_latitude, double current_longitude, double drop_off_latitude,
			double drop_off_longitude, int headcount, int status, int partner_id, int talking, int smoking,
			int partner_gender, String registration_date, int stand_by_id, String nickname, int gender, double prtnr_current_latitude, double prtnr_current_longitude) {
		this.request_id = request_id;
		this.id = id;
		this.current_latitude = current_latitude;
		this.current_longitude = current_longitude;
